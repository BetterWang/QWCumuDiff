...
config.General.requestName = 'PAHM0_KscumuSBNeg_eff_v1'
...
config.General.requestName = 'PAHM1_KscumuSBNeg_eff_v1'
...
config.General.requestName = 'PAHM2_KscumuSBNeg_eff_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM3_KscumuSBNeg_eff_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM4_KscumuSBNeg_eff_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM5_KscumuSBNeg_eff_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM6_KscumuSBNeg_eff_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM7_KscumuSBNeg_eff_v1'
