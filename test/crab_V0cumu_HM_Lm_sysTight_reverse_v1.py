...
config.General.requestName = 'PAHM0_Lmcumu_sysTight_eff_reverse_v1'
...
#config.General.requestName = 'PAHM1_Lmcumu_sysTight_eff_reverse_v1'
...
config.General.requestName = 'PAHM2_Lmcumu_sysTight_eff_reverse_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM3_Lmcumu_sysTight_eff_reverse_v1_rsb'
...
#config.General.requestName = 'PAHM4_Lmcumu_sysTight_eff_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM5_Lmcumu_sysTight_eff_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM6_Lmcumu_sysTight_eff_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM7_Lmcumu_sysTight_eff_reverse_v1'
