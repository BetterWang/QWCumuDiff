...
config.General.requestName = 'PAHM0_LambdaSBNeg_cumu_eff_v1'
...
config.General.requestName = 'PAHM1_LambdaSBNeg_cumu_eff_v1'
...
config.General.requestName = 'PAHM2_LambdaSBNeg_cumu_eff_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM3_LambdaSBNeg_cumu_eff_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM4_LambdaSBNeg_cumu_eff_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM5_LambdaSBNeg_cumu_eff_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM6_LambdaSBNeg_cumu_eff_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM7_LambdaSBNeg_cumu_eff_v1'
