...
config.General.requestName = 'HIMB5_Kscumu_eff_v2'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_PbPb15_ppReco_Ks_eff_v1.py'
...
### HM6
config.General.requestName = 'HIMB6_Kscumu_eff_v2'
...
### HM7
config.General.requestName = 'HIMB7_Kscumu_eff_v2'
