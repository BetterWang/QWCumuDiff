...
config.General.requestName = 'PAHM0_Omega_cumu_eff_v7'
...
config.General.requestName = 'PAHM1_Omega_cumu_eff_v7'
...
config.General.requestName = 'PAHM7_Omega_cumu_eff_v7'
