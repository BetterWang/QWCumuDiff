...
config.General.requestName = 'PAHM0_Lambda_cumu_eff_v10'
...
config.General.requestName = 'PAHM1_Lambda_cumu_eff_v10'
...
config.General.requestName = 'PAHM2_Lambda_cumu_eff_v10'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM3_Lambda_cumu_eff_v10'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM4_Lambda_cumu_eff_v10'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM5_Lambda_cumu_eff_v10'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM6_Lambda_cumu_eff_v10'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM7_Lambda_cumu_eff_v10'
