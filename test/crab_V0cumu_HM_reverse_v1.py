...
config.General.requestName = 'PAHM0_Kscumu_eff_reverse_v12'
...
config.General.requestName = 'PAHM6_Kscumu_eff_reverse_v12'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM7_Kscumu_eff_reverse_v12'
