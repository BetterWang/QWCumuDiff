...
config.General.requestName = 'PAHM0_Kscumu_eff_reverse_v12_rsb'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_pPb16_HM0_Ks_eff_v2.py'
...
#config.General.requestName = 'PAHM1_Kscumu_eff_reverse_v12_rsb'
...
#config.General.requestName = 'PAHM2_Kscumu_eff_reverse_v12'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM3_Kscumu_eff_reverse_v12'
##try:
##        crabCommand('submit', config = config)
##except HTTPException as hte:
##        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM4_Kscumu_eff_reverse_v12'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM5_Kscumu_eff_reverse_v12_rsb'
...
#config.General.requestName = 'PAHM6_Kscumu_eff_reverse_v12_rsb'
#config.Site.whitelist = ['T2_US_Vanderbilt']
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
...
#config.General.requestName = 'PAHM7_Kscumu_eff_reverse_v12_rsb'
