...
config.General.requestName = 'PAHM0_Lmcumu_sysLoose_eff_reverse_v1'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_pPb16_HM0_Lm_sysLoose_v1.py'
...
#config.General.requestName = 'PAHM1_Lmcumu_sysLoose_eff_reverse_v1'
config.JobType.psetName = 'qwcumu_pPb16_HM1_Lm_sysLoose_v1.py'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM2_Lmcumu_sysLoose_eff_reverse_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM3_Lmcumu_sysLoose_eff_reverse_v1_rsb'
...
#config.General.requestName = 'PAHM4_Lmcumu_sysLoose_eff_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM5_Lmcumu_sysLoose_eff_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM6_Lmcumu_sysLoose_eff_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM7_Lmcumu_sysLoose_eff_reverse_v1'
#config.JobType.psetName = 'qwcumu_pPb16_HM7_Lm_sysLoose_v1.py'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
