...
config.General.requestName = 'PAHM0_KsSBPos_vetoJet20eta20_reverse_v1'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_pPb16_HM0_KsSBPos_vetoJet20eta20_v1.py'
...
##### 1
config.JobType.psetName = 'qwcumu_pPb16_HM1_KsSBPos_vetoJet20eta20_v1.py'
#config.General.requestName = 'PAHM1_KsSBPos_vetoJet20eta20_reverse_v1'
...
#
##### 2
#config.General.requestName = 'PAHM2_KsSBPos_vetoJet20eta20_reverse_v2'
...
#
##### 3
#config.General.requestName = 'PAHM3_KsSBPos_vetoJet20eta20_reverse_v1'
...
#
##### 4
#config.General.requestName = 'PAHM4_KsSBPos_vetoJet20eta20_reverse_v1'
...
#
##### 5
#config.General.requestName = 'PAHM5_KsSBPos_vetoJet20eta20_reverse_v1'
...
#
#### 6
config.General.requestName = 'PAHM6_KsSBPos_vetoJet20eta20_reverse_v1'
...
##### 7
#config.JobType.psetName = 'qwcumu_pPb16_HM7_KsSBPos_vetoJet20eta20_v1.py'
#config.General.requestName = 'PAHM7_KsSBPos_vetoJet20eta20_reverse_v3'
