...
config.General.requestName = 'PAHM0_Lmcumu_sysLoose_eff_v1'
...
#config.General.requestName = 'PAHM1_Lmcumu_sysLoose_eff_v1'
...
config.General.requestName = 'PAHM2_Lmcumu_sysLoose_eff_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM3_Lmcumu_sysLoose_eff_v1_rsb'
...
#config.General.requestName = 'PAHM4_Lmcumu_sysLoose_eff_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM5_Lmcumu_sysLoose_eff_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM6_Lmcumu_sysLoose_eff_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM7_Lmcumu_sysLoose_eff_v1'
