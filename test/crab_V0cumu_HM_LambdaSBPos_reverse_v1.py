...
config.General.requestName = 'PAHM0_LambdaSBPos_cumu_eff_reverse_v2_rsb'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_pPb16_HM0_LmSBPos_eff_v1.py'
...
#config.General.requestName = 'PAHM1_LambdaSBPos_cumu_eff_reverse_v2_rsb'
#config.JobType.psetName = 'qwcumu_pPb16_HM1_LmSBPos_eff_v1.py'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM2_LambdaSBPos_cumu_eff_reverse_v2'
##try:
##        crabCommand('submit', config = config)
##except HTTPException as hte:
##        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM3_LambdaSBPos_cumu_eff_reverse_v2'
##try:
##        crabCommand('submit', config = config)
##except HTTPException as hte:
##        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM4_LambdaSBPos_cumu_eff_reverse_v2'
##try:
##        crabCommand('submit', config = config)
##except HTTPException as hte:
##        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM5_LambdaSBPos_cumu_eff_reverse_v2'
##try:
##        crabCommand('submit', config = config)
##except HTTPException as hte:
##        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM6_LambdaSBPos_cumu_eff_reverse_v2'
##try:
##        crabCommand('submit', config = config)
##except HTTPException as hte:
##        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM7_LambdaSBPos_cumu_eff_reverse_v2_rsb'
config.JobType.psetName = 'qwcumu_pPb16_HM7_LmSBPos_eff_v1.py'
