...
config.General.requestName = 'PAHM0_LambdaSBPos_cumu_eff_reverse_v1'
...
config.General.requestName = 'PAHM1_LambdaSBPos_cumu_eff_reverse_v1'
...
config.General.requestName = 'PAHM2_LambdaSBPos_cumu_eff_reverse_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM3_LambdaSBPos_cumu_eff_reverse_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM4_LambdaSBPos_cumu_eff_reverse_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM5_LambdaSBPos_cumu_eff_reverse_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM6_LambdaSBPos_cumu_eff_reverse_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM7_LambdaSBPos_cumu_eff_reverse_v1'
