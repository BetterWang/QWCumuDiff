...
process.QWVetoJet = cms.EDFilter('QWJetPtFilter',
        src = cms.untracked.InputTag('akPu3PFJets'),
        Etamin = cms.untracked.double(-2.),
...
#
process.ana120 = cms.Path(process.hltHM120*process.eventSelection*process.Noff*process.ppNoffFilter120*process.PFTowers*process.akPu3PFJets*process.QWVetoJet*process.QWEvent * process.QWEventS * process.QWEventRef2 * process.QWCumuDiff * process.mon120 )
process.ana150 = cms.Path(process.hltHM150*process.eventSelection*process.Noff*process.ppNoffFilter150*process.PFTowers*process.akPu3PFJets*process.QWVetoJet*process.QWEvent * process.QWEventS * process.QWEventRef2 * process.QWCumuDiff * process.mon150 )
process.ana185 = cms.Path(process.hltHM185*process.eventSelection*process.Noff*process.ppNoffFilter185*process.PFTowers*process.akPu3PFJets*process.QWVetoJet*process.QWEvent * process.QWEventS * process.QWEventRef2 * process.QWCumuDiff * process.mon185 )
process.ana250 = cms.Path(process.hltHM250*process.eventSelection*process.Noff*process.ppNoffFilter250*process.PFTowers*process.akPu3PFJets*process.QWVetoJet*process.QWEvent * process.QWEventS * process.QWEventRef2 * process.QWCumuDiff * process.mon250 )
