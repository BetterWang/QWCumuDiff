...
config.General.requestName = 'PAHM0_H_vetoJet25_reverse_v1'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_pPb16_HM0_H_vetoJet25_v1.py'
...
#config.General.requestName = 'PAHM1_H_vetoJet25_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM2_H_vetoJet25_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM3_H_vetoJet25_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM4_H_vetoJet25_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM5_H_vetoJet25_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM6_H_vetoJet25_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#        print "Failed submitting task: %s" % (cle)
#
#config.JobType.psetName = 'qwcumu_pPb16_HM7_H_vetoJet25_v1.py'
###### 7
#config.Data.inputDataset = '/PAHighMultiplicity7/PARun2016C-PromptReco-v1/AOD'
#config.General.requestName = 'PAHM7_H_vetoJet25_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
##### eta20
##### 0
#config.General.requestName = 'PAHM0_H_vetoJet25eta20_reverse_v1'
...
##### 1
#config.General.requestName = 'PAHM1_H_vetoJet25eta20_reverse_v1'
...
##### 7
config.General.requestName = 'PAHM7_H_vetoJet25eta20_reverse_v1'
