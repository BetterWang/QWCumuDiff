...
process.QWEventS = process.QWEvent.clone(
        ...
        Etamin = cms.untracked.double(-1.8),
        Etamax = cms.untracked.double(1.8)
        )
...
process.histPtMax120 = cms.EDAnalyzer('QWHistDAnalyzer',
		src = cms.untracked.InputTag("QWEvent", "ptMax"),
		Nbins = cms.untracked.int32(200),
		start = cms.untracked.double(0),
		end = cms.untracked.double(20),
        )
process.histPtMax150 = process.histPtMax120.clone()
process.histPtMax185 = process.histPtMax120.clone()
process.histPtMax250 = process.histPtMax120.clone()
...
process.mon120 = cms.Sequence(process.histNoff + process.vectPhi120Ks + process.vectPt120Ks + process.vectEta120Ks + process.histPtMax120)
process.mon150 = cms.Sequence(process.histNoff + process.vectPhi150Ks + process.vectPt150Ks + process.vectEta150Ks + process.histPtMax150)
process.mon185 = cms.Sequence(process.histNoff + process.vectPhi185Ks + process.vectPt185Ks + process.vectEta185Ks + process.histPtMax185)
process.mon250 = cms.Sequence(process.histNoff + process.vectPhi250Ks + process.vectPt250Ks + process.vectEta250Ks + process.histPtMax250)

process.QWHighPtVeto10 = cms.EDFilter('QWDoubleFilter',
		src = cms.untracked.InputTag('QWEvent', 'ptMax'),
		dmin = cms.untracked.double(0.),
		dmax = cms.untracked.double(10.),
	)


process.ana120 = cms.Path(process.hltHM120*process.eventSelection*process.Noff*process.ppNoffFilter120*process.QWEvent * process.QWHighPtVeto10 * process.QWEventS * process.QWEventRef2 * process.QWCumuDiff * process.mon120 )
process.ana150 = cms.Path(process.hltHM150*process.eventSelection*process.Noff*process.ppNoffFilter150*process.QWEvent * process.QWHighPtVeto10 * process.QWEventS * process.QWEventRef2 * process.QWCumuDiff * process.mon150 )
process.ana185 = cms.Path(process.hltHM185*process.eventSelection*process.Noff*process.ppNoffFilter185*process.QWEvent * process.QWHighPtVeto10 * process.QWEventS * process.QWEventRef2 * process.QWCumuDiff * process.mon185 )
process.ana250 = cms.Path(process.hltHM250*process.eventSelection*process.Noff*process.ppNoffFilter250*process.QWEvent * process.QWHighPtVeto10 * process.QWEventS * process.QWEventRef2 * process.QWCumuDiff * process.mon250 )
