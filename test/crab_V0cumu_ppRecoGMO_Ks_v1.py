...
config.General.requestName = 'HIMB5_V0cumu_ppRecoGMO_Ks_rapidity_v1'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_PbPb15_ppReco_GMO_Ks_rap_v1.py'
...
### HM6
config.General.requestName = 'HIMB6_V0cumu_ppRecoGMO_Ks_rapidity_v1'
...
### HM7
config.General.requestName = 'HIMB7_V0cumu_ppRecoGMO_Ks_rapidity_v1'
