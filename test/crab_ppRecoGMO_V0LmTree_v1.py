...
config.General.requestName = 'HIMB5_ppRecoGMO_V0LmTree_v1'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qw_PbPb15_ppReco_V0LmTree_v1.py'
...
### HM6
config.General.requestName = 'HIMB6_ppRecoGMO_V0LmTree_v1'
...
### HM7
config.General.requestName = 'HIMB7_ppRecoGMO_V0LmTree_v1'
