...
config.General.requestName = 'PAHM0_LambdaSBNeg_cumu_eff_reverse_v2_rsb'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = True
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_pPb16_HM0_LmSBNeg_eff_v1.py'
...
#config.General.requestName = 'PAHM1_LambdaSBNeg_cumu_eff_reverse_v2'
#config.JobType.psetName = 'qwcumu_pPb16_HM1_LmSBNeg_eff_v1.py'
##try:
##        crabCommand('submit', config = config)
##except HTTPException as hte:
##        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM2_LambdaSBNeg_cumu_eff_reverse_v2'
##try:
##        crabCommand('submit', config = config)
##except HTTPException as hte:
##        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM3_LambdaSBNeg_cumu_eff_reverse_v2_rsb'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM4_LambdaSBNeg_cumu_eff_reverse_v2'
##try:
##        crabCommand('submit', config = config)
##except HTTPException as hte:
##        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM5_LambdaSBNeg_cumu_eff_reverse_v2_rsb'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM6_LambdaSBNeg_cumu_eff_reverse_v2'
##try:
##        crabCommand('submit', config = config)
##except HTTPException as hte:
##        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM7_LambdaSBNeg_cumu_eff_reverse_v2_rsb'
config.JobType.psetName = 'qwcumu_pPb16_HM7_LmSBNeg_eff_v1.py'
