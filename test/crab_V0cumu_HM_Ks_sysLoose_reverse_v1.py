...
config.General.requestName = 'PAHM0_Kscumu_sysLoose_eff_reverse_v1'
...
#config.General.requestName = 'PAHM1_Kscumu_sysLoose_eff_reverse_v1'
...
config.General.requestName = 'PAHM2_Kscumu_sysLoose_eff_reverse_v1'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM3_Kscumu_sysLoose_eff_reverse_v1_rsb'
...
#config.General.requestName = 'PAHM4_Kscumu_sysLoose_eff_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM5_Kscumu_sysLoose_eff_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM6_Kscumu_sysLoose_eff_reverse_v1'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#config.General.requestName = 'PAHM7_Kscumu_sysLoose_eff_reverse_v1'
