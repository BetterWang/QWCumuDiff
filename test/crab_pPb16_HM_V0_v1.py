...
config.General.requestName = 'PAHM0_V0_v2'
...
config.General.requestName = 'PAHM1_V0_v2'
...
config.General.requestName = 'PAHM2_V0_v2'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM3_V0_v2'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM4_V0_v2'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM5_V0_v2'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM6_V0_v2'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'PAHM7_V0_v2'
