...
config.General.requestName = 'HIMB4_V0Cumu_Lm_Peak_Mid_BDT25_v1'
...
config.JobType.pyCfgParams = ['part=LM', 'massRange=Peak', 'rap=Mid', 'BDT=0.25']
...
config.General.requestName = 'HIMB3_V0Cumu_Lm_Peak_Mid_BDT25_v1'
