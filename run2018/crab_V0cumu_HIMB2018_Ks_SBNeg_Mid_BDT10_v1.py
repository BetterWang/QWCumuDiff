...
config.General.requestName = 'HIMB4_V0Cumu_Ks_SBNeg_Mid_BDT10_v2'
...
config.JobType.pyCfgParams = ['part=KS', 'massRange=SBNeg', 'rap=Mid', 'BDT=0.10']
...
config.General.requestName = 'HIMB3_V0Cumu_Ks_SBNeg_Mid_BDT10_v2'
