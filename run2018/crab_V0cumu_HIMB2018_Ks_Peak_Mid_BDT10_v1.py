...
config.General.requestName = 'HIMB4_V0Cumu_Ks_Peak_Mid_BDT10_v2'
...
config.JobType.pyCfgParams = ['part=KS', 'massRange=Peak', 'rap=Mid', 'BDT=0.10']
...
config.General.requestName = 'HIMB3_V0Cumu_Ks_Peak_Mid_BDT10_v2'
