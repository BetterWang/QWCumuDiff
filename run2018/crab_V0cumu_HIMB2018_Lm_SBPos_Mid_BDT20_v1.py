...
config.General.requestName = 'HIMB4_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
config.JobType.pyCfgParams = ['part=LM', 'massRange=SBPos', 'rap=Mid', 'BDT=0.20']
...
#config.General.requestName = 'HIMB1_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#config.General.requestName = 'HIMB2_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB19_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB3_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB18_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#config.General.requestName = 'HIMB17_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#
#
#config.General.requestName = 'HIMB16_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#
#
#config.General.requestName = 'HIMB15_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB14_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB13_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB12_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB11_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB10_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB9_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB8_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB7_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB5_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB6_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB0_V0Cumu_Lm_SBPos_Mid_BDT20_v1'
...
#
#
#config.General.requestName = 'HIMB0_V0Cumu_Lm_SBPos1_Mid_BDT20_v1'
#config.Data.inputDataset = '/HIMinimumBias0/qwang-V0Skim_v3-5f932986cf38f9e8dbd6c3aea7f6c2b4/USER'
#config.JobType.pyCfgParams = ['part=LM', 'massRange=SBPos1', 'rap=Mid', 'BDT=0.20']
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB1_V0Cumu_Lm_SBPos1_Mid_BDT20_v1'
#config.Data.inputDataset = '/HIMinimumBias1/qwang-V0Skim_v3-5f932986cf38f9e8dbd6c3aea7f6c2b4/USER'
#config.JobType.pyCfgParams = ['part=LM', 'massRange=SBPos1', 'rap=Mid', 'BDT=0.20']
#try:
#        crabCommand('submit', config = config)
...
#        print "Failed submitting task: %s" % (cle)
#
#config.General.requestName = 'HIMB2_V0Cumu_Lm_SBPos1_Mid_BDT20_v1'
#config.Data.inputDataset = '/HIMinimumBias2/qwang-V0Skim_v3-5f932986cf38f9e8dbd6c3aea7f6c2b4/USER'
#config.JobType.pyCfgParams = ['part=LM', 'massRange=SBPos1', 'rap=Mid', 'BDT=0.20']
#try:
#        crabCommand('submit', config = config)
...
#config.General.requestName = 'HIMB0_V0Cumu_Lm_SBPos_Mid_BDT20_noAPCut_v1'
#config.Data.inputDataset = '/HIMinimumBias0/qwang-V0Skim_v3-5f932986cf38f9e8dbd6c3aea7f6c2b4/USER'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
...
#        print "Failed submitting task: %s" % (cle)
#
config.General.requestName = 'HIMB1_V0Cumu_Lm_SBPos_Mid_BDT20_noAPCut_v1'
config.Data.inputDataset = '/HIMinimumBias1/qwang-V0Skim_v3-5f932986cf38f9e8dbd6c3aea7f6c2b4/USER'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
