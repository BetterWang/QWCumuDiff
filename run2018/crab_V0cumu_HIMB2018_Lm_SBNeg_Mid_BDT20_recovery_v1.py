...
config.Data.lumiMask = 'CrabArea/crab_HIMB2_V0Cumu_Lm_SBNeg_Mid_BDT20_v1/results/notFinishedLumis.json'
config.General.requestName = 'HIMB4_V0Cumu_Lm_SBNeg_Mid_BDT20_recovery_v1'
