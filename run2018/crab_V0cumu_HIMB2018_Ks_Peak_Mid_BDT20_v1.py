...
config.General.requestName = 'HIMB4_V0Cumu_Ks_Peak_Mid_BDT20_v2'
...
config.JobType.pyCfgParams = ['part=KS', 'massRange=Peak', 'rap=Mid', 'BDT=0.20']
...
config.General.requestName = 'HIMB3_V0Cumu_Ks_Peak_Mid_BDT20_v2'
