...
#config.General.requestName = 'HIMB2_V0Cumu_Ks_Peak_Mid_recovery_v1'
#config.Data.inputDataset = '/HIMinimumBias2/qwang-V0Skim_v3-5f932986cf38f9e8dbd6c3aea7f6c2b4/USER'
#config.Data.lumiMask = 'CrabArea/crab_HIMB2_V0Cumu_Ks_Peak_Mid_v2/results/notFinishedLumis.json'
#try:
#        crabCommand('submit', config = config)
#except HTTPException as hte:
#        print "Failed submitting task: %s" % (hte.headers)
...
config.General.requestName = 'HIMB1_V0Cumu_Ks_Peak_Mid_recovery_v1'
config.Data.inputDataset = '/HIMinimumBias1/qwang-V0Skim_v3-5f932986cf38f9e8dbd6c3aea7f6c2b4/USER'
config.Data.lumiMask = 'CrabArea/crab_HIMB1_V0Cumu_Ks_Peak_Mid_v2/results/notFinishedLumis.json'
try:
        crabCommand('submit', config = config)
except HTTPException as hte:
        print "Failed submitting task: %s" % (hte.headers)
