...
config.General.requestName = 'HIMB0_V0Cumu_Lm_SBNeg_Mid_BDT20Cent_v1'
config.General.workArea = 'CrabArea'
config.General.transferOutputs = True
config.General.transferLogs = False
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'qwcumu_PbPb18_V0Cent_v2s.py'
#config.JobType.maxJobRuntimeMin = 2500
config.JobType.inputFiles = ['TMVAClassification_BDT250_D4.LM_1.weights.xml', 'TMVAClassification_BDT250_D4.LM_2.weights.xml', 'TMVAClassification_BDT250_D4.LM_3.weights.xml', 'TMVAClassification_BDT250_D4.LM_4.weights.xml']
...
#
#
#config.General.requestName = 'HIMB1_V0Cumu_Lm_SBNeg_Mid_BDT20Cent_v1'
...
#
#
#config.General.requestName = 'HIMB2_V0Cumu_Lm_SBNeg_Mid_BDT20Cent_v1'
...
#
#
#config.General.requestName = 'HIMB3_V0Cumu_Lm_SBNeg_Mid_BDT20Cent_v1'
...
config.General.requestName = 'HIMB5_V0Cumu_Lm_SBNeg_Mid_BDT20Cent_v1'
