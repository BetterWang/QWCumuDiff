...
process.MCBias = cms.EDProducer('QWMCBias',
        srcCentrality = cms.untracked.InputTag('dbCent'),
        pTrkPt = cms.untracked.InputTag('QWV0MVAVector', 'pTrkPt'),
        nTrkPt = cms.untracked.InputTag('QWV0MVAVector', 'nTrkPt')
    )
process.MCBiasCent = cms.EDProducer('QWMCBiasCent',
        srcCentrality = cms.untracked.InputTag('dbCent')
    )
...
process.QWV0MVA = cms.EDProducer('QWV0MVAVectProducer'
        ...
        , dbCent = cms.untracked.InputTag('MCBiasCent', 'Centrality')
...
process.QWCumuDiff = cms.EDAnalyzer('QWCumuDiff',
        ...
        sigSet = cms.untracked.PSet(
            ...
            Weight = cms.untracked.InputTag('MCBias', 'weight'),
            ),
